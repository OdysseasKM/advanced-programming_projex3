...
// code to reconnect to the broker would go here if desired
	 ...
	 *
	 */
	public void runClient(Message message_send) {
// setup MQTT Client
...
// Connect to Broker
		...
		MqttMessage message = new MqttMessage(message_send.getText().getBytes());
		message.setQos(pubQoS);
		message.setRetained(false);
// Publish the message
		log.info("Publishing to topic \"" + topic + "\" qos " + pubQoS + "\" text " + message_send.getText());
